...
console.log(req.body)
        try {
            const existingMeseretawiByEmail = await prisma.wana.findFirst(
                {
                    where: {email: email}
                }
            )
            ...
            const existingMeseretawiByPhone = await prisma.wana.findFirst(
                {
                    where: {phone: phone}
                }
            )
            ...
            const existingMeseretawiByUsername = await prisma.wana.findFirst(
                {
