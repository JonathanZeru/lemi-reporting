...
import { MeseretawiRegistrationFormData, meseretawiRegistrationSchema } from "@/schemas/meseretawiRegistrationSchema"

const MeseretawiRegistration = () => {
  ...
  const {
    ...
    formState: { errors },
    watch,
  } = useForm<MeseretawiRegistrationFormData>({
    resolver: zodResolver(meseretawiRegistrationSchema),
    defaultValues: {
      firstName: "",
      lastName: "",
      email: "",
...
export default MeseretawiRegistration
