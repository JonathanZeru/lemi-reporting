import { MeseretawiDirijetNotification } from '@/types/types'
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table"
import { format } from 'date-fns'
import { useRouter } from 'next/navigation'
const MeseretawiNotification = ({myMeseretawiNotifications}:{myMeseretawiNotifications:
     MeseretawiDirijetNotification[]}) => {
  ...
  return (
    ...
    <TableBody>
        { myMeseretawiNotifications.map((notification) => (
            <TableRow key={notification.id} className="hover:bg-slate-200"
                ...
                <TableCell>{notification.hiwas == null ? "": notification.hiwas.firstName} 
                    {notification.hiwas == null ? "":notification.hiwas.lastName}</TableCell>
